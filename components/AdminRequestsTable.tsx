            ...
            return (
              <tr key={req.id} className="hover:bg-slate-50/50 transition-colors">
                <td className="px-6 py-4">
                  ...
                  <div className="text-xs text-slate-500 mt-1">{solicitante?.email}</div>
                ...
                <td className="px-6 py-4">
                  <span className={`px-3 py-1 rounded text-xs font-bold uppercase tracking-wider ${badgeClass}`}>{req.status}</span>
                </td>
                <td className="px-6 py-4">
